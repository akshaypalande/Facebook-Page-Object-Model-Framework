...
public class ProfilePage extends BaseClass {
	@FindBy(xpath = "//span[contains(text(),'Sapirli Konkan')]")
	...
	public ProfilePage click_photoUpload() throws InterruptedException, IOException, AWTException {
		...
		Runtime.getRuntime().exec("C:\\Users\\HP\\eclipse-workspace\\Facebook-Framework-Page-Object-Model\\Photo\\teddy.exe");
