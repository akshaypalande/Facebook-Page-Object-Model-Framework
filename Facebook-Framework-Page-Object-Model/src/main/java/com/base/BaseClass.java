...
public class BaseClass {
	...
	public BaseClass() {
		...
		try {
			ip= new FileInputStream("C:\\Users\\HP\\eclipse-workspace\\Facebook-Framework-Page-Object-Model\\src\\main\\java\\com\\config\\config.properties");
	...
	public static void initialization() {
		...
		if(browserName.equals("chrome")) {
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\HP\\eclipse-workspace\\Drivers\\chromedriver.exe");
			 ...
			 System.setProperty("webdriver.gecko.driver", "C:\\Users\\HP\\eclipse-workspace\\Drivers\\geckodriver.exe");
